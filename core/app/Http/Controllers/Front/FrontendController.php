...
// -------------------------------- HOME ----------------------------------------
        ...
        public function index()
        {
            ...
            return view('front.index', [
                ...
                'setting'                => $setting,
                'extra_settings'         => ExtraSetting::first()
            ]);
        }
        ...
        public function indexApi()
        {
            ...
            if ($setting->theme == 'theme1') {
                $sliders = Item::with('category')->whereStatus(1)->get();
            } elseif ($setting->theme == 'theme2') {
                $sliders = Slider::where('home_page', 'theme2')->get();
            } elseif ($setting->theme == 'theme3') {
                $sliders = Slider::where('home_page', 'theme3')->get();
...
//            $data               = [];
//            $data['sliders']    = Slider::where('home_page', 'theme1')->get();
...
//                'products' => Item::whereStatus(1)->get(),
//                'home_page4_banner'      => json_decode($home_customize->home_page4, true),
//                'pupular_cateogry_home4' => isset($pupular_cateogry_home4) ? $pupular_cateogry_home4 : [],
//                // feature category
//                'feature_category_items' => $feature_category_items,
...
//                'two_column_categoriess' => $two_column_categoriess,
        ...
        {
            if (is_numeric($slug)) {
                $item = Item::with('category')->whereStatus(1)->whereId($slug)->firstOrFail();
                return collect([
                    'item'      => $item,
                ...
                $item  = Item::with('category')
                    ->whereStatus(1)->whereSlug($slug)->firstOrFail();
